...
const commands:Command[] = [
  ...
  {label:'Forderungen', icon:'💰', href:'/anwalt/kanzlei/forderungen', keywords:['forderung','claim','schuldner']},
  {label:'Workflows', icon:'⚙️', href:'/anwalt/kanzlei/workflows', keywords:['workflow','automatisierung','prozess']},
  {label:'Wiedervorlagen', icon:'🔔', href:'/anwalt/kanzlei/wiedervorlagen', keywords:['wiedervorlage','erinnerung','reminder']},
